...
# \mainpage RoboComp::textrecognition
#
...
#
# Just: "${PATH_TO_BINARY}/textrecognition --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	adapter = ic.createObjectAdapter('TextRecognition')
	adapter.add(TextRecognitionI(worker), ic.stringToIdentity('textrecognition'))
	adapter.activate()
